...
export type Subscription = {
  ...
  vehicleIds: Array<Scalars['String']['output']>;
  vehiclePosition?: Maybe<VehiclePosition>;
  vehiclePositions: Array<VehiclePosition>;
};


export type SubscriptionVehiclePositionArgs = {
